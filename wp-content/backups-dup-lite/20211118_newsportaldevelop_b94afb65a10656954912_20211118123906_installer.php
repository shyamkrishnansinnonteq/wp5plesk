...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211118_newsportaldevelop_b94afb65a10656954912_20211118123906_archive.zip';
	const ARCHIVE_SIZE		 = '305733';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'b94afb6-18123906';
    const SECONDARY_PACKAGE_HASH = '1e5469f-18123906';
	const VERSION			 = '1.4.3';
