...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211118_newsportaldevelop_3bcfa5efa5e1e0453081_20211121153550_archive.zip';
	const ARCHIVE_SIZE		 = '279854';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3bcfa5e-21153550';
    const SECONDARY_PACKAGE_HASH = '3d0f560-21153550';
	const VERSION			 = '1.4.3';
