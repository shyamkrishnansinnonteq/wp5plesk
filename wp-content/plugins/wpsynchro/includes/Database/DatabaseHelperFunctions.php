...
class DatabaseHelperFunctions
{
    ...
    public function getLastDBQueryErrors()
    {
        ...
        $base_error = sprintf(
            __('Synchronization aborted, due to a SQL query failing. See log for specific information about the query that failed. The specific error from SQL server was: "%s".', 'wpsynchro'),
            $wpdb->last_error
        );
