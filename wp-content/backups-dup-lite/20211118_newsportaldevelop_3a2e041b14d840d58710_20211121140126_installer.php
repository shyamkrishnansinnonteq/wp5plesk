...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20211118_newsportaldevelop_3a2e041b14d840d58710_20211121140126_archive.zip';
	const ARCHIVE_SIZE		 = '205069';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '3a2e041-21140126';
    const SECONDARY_PACKAGE_HASH = '53d1998-21140126';
	const VERSION			 = '1.4.3';
